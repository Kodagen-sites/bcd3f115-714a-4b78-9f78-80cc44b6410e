...
export default function ServiceCardV6({ service, index, imageSrc }: Props) {
  ...
  return (
    <Link
      id={service.slug}
      href="/#contact"
      className="group relative block h-full scroll-mt-28 bg-white transition-transform duration-150 ease-out hover:-translate-x-1 hover:-translate-y-1"
      style={{
        color: "#0E1C33",
        border: "3px solid #0E1C33",
        boxShadow: "8px 8px 0 0 #0E1C33",
      }}
      onMouseEnter={(e) => (e.currentTarget.style.boxShadow = "4px 4px 0 0 #1F3252")}
      onMouseLeave={(e) => (e.currentTarget.style.boxShadow = "8px 8px 0 0 #0E1C33")}
    >
      {imageSrc && (
        <div
          className="relative aspect-[4/3] overflow-hidden"
          style={{ borderBottom: "3px solid #0E1C33" }}
        >
          <img
            src={imageSrc}
            alt={service.name}
      ...
      <div className="p-6 md:p-7">
        ...
        <div
          ...
          style={{ borderTop: "2px solid #0E1C33" }}
        >
          Request brief
        </div>
      </div>
